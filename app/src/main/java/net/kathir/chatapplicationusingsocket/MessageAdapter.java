package net.kathir.chatapplicationusingsocket;
        ...
        try {
            if (message.getBoolean("isSent")) {
                ...
                if (message.has("message")) {
                    ...
                    Toast.makeText(context,"Send an image",Toast.LENGTH_SHORT).show();
                ...
                if (message.has("message")) {
                    ...
                    Bitmap bitmap = getBitmapFromString(message.getString("image"));
                    imageHolder.imageView.setImageBitmap(bitmap);
                    Toast.makeText(context,"Received an image",Toast.LENGTH_SHORT).show();
